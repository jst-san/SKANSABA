          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-200 font-semibold tracking-wider uppercase">
          ...
          <div className="md:col-span-4 space-y-3">
            ...
            <div className="space-y-2.5 text-xs text-slate-200">
              <div className="flex items-center gap-2.5">
                <LuPhone className="w-4 h-4 text-sky-200" />
                <span>+62 274 367 156</span>
              </div>
              <div className="flex items-center gap-2.5">
                <LuMail className="w-4 h-4 text-sky-200" />
                <span>info@smkn1bantul.sch.id</span>
              </div>
              <div className="flex items-center gap-2.5">
                <LuClock className="w-4 h-4 text-sky-200" />
