      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {MITRA_INDUSTRI.map((partner, idx) => (
            <div key={idx} className="p-4 rounded-xl bg-slate-50 border border-slate-100 text-center flex flex-col items-center justify-center hover:bg-sky-100/50 hover:border-blue-200 transition-colors">
