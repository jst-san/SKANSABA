    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          {/* Modal Container */}
          <motion.div
            className="relative w-full max-w-3xl bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-2xl z-10"
          ...
          >
            ...
            <div className="aspect-video w-full bg-slate-900 flex flex-col items-center justify-center p-6 text-center text-white">
              ...
              <h4 className="text-xl font-bold mb-2">
                Simulasi LuPlayer Video Profil
              </h4>
              <p className="text-slate-300 text-sm max-w-md">
                Menampilkan ikhtisar fasilitas Teaching Factory, kegiatan
                belajar 7 Jurusan, serta atmosfer kampus SMKN 1 Bantul.
              </p>
            </div>
          </motion.div>
        </div>
